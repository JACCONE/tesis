                              ...
                              <q-card>
                                <div id="accion">
                                    <div class="selecciones q-mr-xl">
                                      ...
                                      <span class="text-subtitle1">Rúbrica</span>
                                    </div>
                                    <div  class="selecciones">
                                        <div class="q-mb-xs">
                                          <q-select filled v-model="model.cam" @input="habilitar_dis(model.cam)" :disable ="hab.cam" :options="campo" label="Seleccione" option-value="id"
                                          option-label="nombre" dense></q-select> 
                                        </div>
                                        <div class="q-mb-xs">
                                          <q-select  filled v-model="model.dis" @input="habilitar_sub(model.dis)" :disable ="hab.dis" :options="disciplina" label="Seleccione" option-value="id"
                                          option-label="nombre"  dense></q-select>
                                        </div>
                                        <div class="q-mb-xs">
                                          <q-select filled v-model="model.sub" @input="habilitar_mat(model.sub)" :disable ="hab.sub" :options="subdisciplina" label="Seleccione" option-value="id"
                                          option-label="nombre"  dense></q-select>
                                        </div>
                                        <div class="q-mb-xs">
                                          <q-select filled v-model="model.mat" :disable ="hab.mat" :options="materia" label="Seleccione" option-value="id"
                                          option-label="nombre" dense></q-select>
                                        </div>
                                        
                                        <div class="q-mb-xs">
                                          <q-select filled v-model="model.rub" @input="mostrar_rubrica(model.rub)" :disable ="hab.rub" :options="rubrica" label="Seleccione" option-value="id"
                                          option-label="nombre" dense></q-select>
                                        </div>
                                    </div>
                                </div>
                      ...
                      <div id="inferior">
                        ...
                        <div id="rubrica_interna">
                          ...
                          <q-page-sticky position="bottom-right" :offset="[18, 18]">
                            <q-btn fab icon="add" color="accent" @click = "actualizar_bd()"></q-btn>
                          </q-page-sticky>
                        </div>
                        </div>
...
{{-- modal para cambiar descripcion de los  niveles--}}
...
<q-dialog v-model="alert4">
  <q-card>
    ...
    <q-card-actions align="right" style="background: #114c0f;">
      <q-btn flat label="Continuar" color="white" @click = "cargar_data_rubrica()"></q-btn>
      <q-btn flat label="Cancelar" color="white" v-close-popup></q-btn>
    </q-card-actions>
  </q-card>
</q-dialog>

{{-- modal para mensaje de actualizar rubrica --}}
{{-- <q-dialog v-model="alert5">
  <q-card>
    <q-card-section style="padding-top:13px;padding-bottom:8px;border-bottom:1px solid #d0d0d0;">
      <div class="text-h6">Actualización Rúbrica:</div>
    </q-card-section>

    <q-card-section class="q-pt-none">
      <div>Esta accción actualizará la rubrica seleccionada</div>
    </q-card-section>

    <q-card-actions align="right" style="background: #114c0f;">
      <q-btn flat label="Cancelar" color="white" v-close-popup></q-btn>
      <q-btn flat label="Continuar" color="white" @click = "actualizar_rubrica_bd()"></q-btn>
    </q-card-actions>
  </q-card>
</q-dialog> --}}
